...
export class AIService {
     ...
     */
    async sendMessage(sessionId, message, conversationId) {
        try {
     ...
     */
    async startServiceConversation(sessionId, serviceName) {
     ...
     */
    async startBookingConversation(sessionId, serviceName) {
     ...
     */
    async getServiceRecommendations(sessionId, preferences) {
     ...
     */
    async handleUrgentBooking(sessionId, urgencyLevel) {
        let message = "";
        switch (urgencyLevel) {
            case "asap":
     ...
     */
    extractMentionedServices(messages) {
     ...
     */
    extractSpecialRequests(messages) {
...
export async function sendChatMessage(sessionId, message, conversationId) {
